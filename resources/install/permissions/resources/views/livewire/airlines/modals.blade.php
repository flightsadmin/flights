                ...
                <form>
                    <div class="row">
                        ...
                        <div class="form-group col-md-6 mb-2">
                            ...
                            <input type="text" maxlength="2" class="form-control" id="iata_code" wire:model.blur="iata_code">
                            @error('iata_code') <span class="text-danger small">{{ $message }}</span> @enderror
                        </div>
                        <div class="form-group col-md-6 mb-2">
                            <label for="base">Airline Base</label>
                            <input type="text" class="form-control" id="base" wire:model.blur="base">
                    ...
                    <form>
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" maxlength="4" class="form-control" wire:model.blur="origin">
                                @error('origin') <span class="text-danger small">{{ $message }}</span> @enderror
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="destination">Destination:</label>
                                <input type="text" maxlength="34" class="form-control" wire:model.blur="destination">
                                @error('destination') <span class="text-danger small">{{ $message }}</span> @enderror
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="flight_time">Flight Time:</label>
                                <input maxlength="4" class="form-control form-control-sm" type="text" wire:model.blur="flight_time" placeholder="0000">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="d-flex gap-4">
                                    <input type="text" class="form-control form-control-sm" wire:model.blur="email" placeholder="example test@test.com">
